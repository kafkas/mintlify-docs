...
```bash TS (frontend)
typesync generate --platform ts:firebase:10 # ... other options
```

```bash TS (backend)
typesync generate --platform ts:firebase-admin:11 # ... other options
```

```bash Python
typesync generate --platform py:firebase-admin:6 # ... other options
```
