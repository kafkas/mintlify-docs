...
```bash TS (frontend)
typesync generate-ts --platform firebase@10 --definition models.yml # ... other options
```

```bash TS (backend)
typesync generate-ts --platform firebase-admin@11 --definition models.yml # ... other options
```

```bash Python
typesync generate-py --platform firebase-admin@6 --definition models.yml # ... other options
```
