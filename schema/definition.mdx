...
The Typesync schema for a project is defined in a collection of YAML/JSON files. Your definition can contain as many model definition files as you need and you can organize them any way you want. There are two types of models that you can define in a model definition file: _document models_ and _alias models_.

<Note>We use the terms _definition_ and _schema_ interchangeably.</Note>
...
<Tabs>
  ...
  <Tab title="JSON definition">
    ...
    of each definition file.
      ...
      ```json
      {
        "$schema": "https://schema.typesync.org/v0.8.json"
        // ...
      }
      ```

      This indicates to your IDE that the file is not just any JSON file but a part of a Typesync definition. This will allow your IDE to provide Intellisense/autocomplete for definition fields.
